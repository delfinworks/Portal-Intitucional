...
if(!defined('_JS_PHP__PAGE_TITLE_FOR_PAGES_OUTSIDE_JOOMLA_CMS'))
...
//   #__jstats_page_request_c   j                  //will be renamed to #__jstats_impression_sums
//   #__jstats_pages            p
//   #__jstats_referrer         r         
...
$__jstats_ostype = array(
	_JS_DB_OSTYP__ID_UNKNOWN        => array('os_type' => _JS_DB_OSTYP__ID_UNKNOWN,        'ostype_name' => 'Unknown',            'ostype_img' => 'unknown'),
	_JS_DB_OSTYP__ID_WINDOWS        => array('os_type' => _JS_DB_OSTYP__ID_WINDOWS,        'ostype_name' => 'Windows',            'ostype_img' => 'windowsxp'),
	_JS_DB_OSTYP__ID_LINUX_UNIX_MAC => array('os_type' => _JS_DB_OSTYP__ID_LINUX_UNIX_MAC, 'ostype_name' => 'Linux, Unix or Mac', 'ostype_img' => 'linux'),
	_JS_DB_OSTYP__ID_PDA_PHONE      => array('os_type' => _JS_DB_OSTYP__ID_PDA_PHONE,      'ostype_name' => 'PDA or Phone',       'ostype_img' => 'pda'),
	_JS_DB_OSTYP__ID_OTHER          => array('os_type' => _JS_DB_OSTYP__ID_OTHER,          'ostype_name' => 'Other',              'ostype_img' => 'other'),
);
...
$__jstats_browserstype = array(
	_JS_DB_BRTYP__ID_UNKNOWN            => array('os_type' => _JS_DB_BRTYP__ID_UNKNOWN,           'browsertype_name' => 'Unknown',           'browsertype_img' => 'unknown'),
	_JS_DB_BRTYP__ID_INTERNET_EXPLORER  => array('os_type' => _JS_DB_BRTYP__ID_INTERNET_EXPLORER, 'browsertype_name' => 'Internet Explorer', 'browsertype_img' => 'explorer'),
	_JS_DB_BRTYP__ID_FIREFOX            => array('os_type' => _JS_DB_BRTYP__ID_FIREFOX,           'browsertype_name' => 'Fire Fox',          'browsertype_img' => 'firefox'),
	_JS_DB_BRTYP__ID_OPERA              => array('os_type' => _JS_DB_BRTYP__ID_OPERA,             'browsertype_name' => 'Opera',             'browsertype_img' => 'opera'),
	_JS_DB_BRTYP__ID_PDA_PHONE          => array('os_type' => _JS_DB_BRTYP__ID_PDA_PHONE,         'browsertype_name' => 'PDA or Phone',      'browsertype_img' => 'pda'),
	_JS_DB_BRTYP__ID_OTHER              => array('os_type' => _JS_DB_BRTYP__ID_OTHER,             'browsertype_name' => 'Other',             'browsertype_img' => 'other'),
);
