 ...
 */
class j4ageViewWhois extends JView
{
	/**
	...
	/*
        ...
        */
        ...
        require_once( dirname(__FILE__) .DS. '..'.DS. '..' .DS. 'api' .DS.'whois.class.php' );
        $whois = new whois();
        $address_to_check = JRequest::getVar( 'address_to_check', '' );
        $domainName = $address_to_check;
        $this->assignRef("whois", $whois);
        $this->assignRef("domainName", $domainName);
        $this->assignRef("address_to_check", $address_to_check);
