 ...
 */
class j4ageViewVisitors extends JView
{                    
	/**
	...
	/*
        ...
        */
		...
		$query  = 'SELECT count(DISTINCT v.client_id, v.visit_id) as visits, v.visit_id, a.ip AS aid, a.ip, a.ip_type,  a.ip_exclude, a.code, a.nslookup, c.*, i2nc.country, sy.os_name as system, sy.os_img, br.browser_name, br.browser_img, c.browser_version, MAX(v.joomla_userid) as joomla_userid, MAX(ju.name) AS joomla_username, MAX(v.changed_at) as changed_at, MIN(v.changed_at) as first_visit_at'
