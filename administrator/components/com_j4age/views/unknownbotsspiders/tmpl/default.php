<?php defined('_JEXEC') or die('JS: No Direct Access'); ?>
		...
		<thead>
            <tr>
                ...
                <th align="left" width="60%"><?php echo  JTEXT::_( 'UserAgent' );?></th>
    ...
    ?>
            	<tr><td colspan="8" style="text-align:center"><?php echo  JTEXT::_( 'No data' );?></td></tr>
        	<?php
