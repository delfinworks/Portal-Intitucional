...
class js_JSTemplate
{
	 ...
	 * @return string
	 */
	function generateAdminForm( $task = '', $view = ''  ) {
		$form  = $this->generateBeginingOfAdminForm( $task, $view ) . $this->generateEndOfAdminForm();
	 ...
	 * @return unknown
	 */
	function generateBeginingOfAdminForm( $task = '', $view = ''  ) {
		$form  = '<form name="adminForm" id="adminForm" method="post" action="index.php" style="display: inline; margin: 0px; padding: 0px;" onsubmit="return true;">
                ...
                <input type="hidden" name="controller" value="'.JRequest::getVar('controller', 'main').'" />
                <input type="hidden" name="view" value="' . $view . '" />
                <input type="hidden" name="tpl" value="" />
                <input type="hidden" name="mid" value="" />
                <input type="hidden" name="returnView" value="" />
