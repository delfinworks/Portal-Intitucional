...
//			array( 'hash' => 4, 'name' => 'jstats_page_request_c', 'native_name' => JTEXT::_( 'Page hits summarized' ) ),
            ...
            array( 'hash' => 8, 'name' => 'jstats_clients',		   'native_name' => JTEXT::_( 'Clients' ) )
		);
...
class js_ExportBase
{
	...
	function __getExportDescription( $tableHash, $fileName, &$desc ) {
		...
		. 'dumped from Joomla CMS, by j4age component version: \'' . $JSVersion . '\'.'
		. 'File name: \'' . $fileName . '\'. '
		. 'Data dumped at: \'' . $now . '\' joomla local time. '
		. 'Data dumped at: \'' . js_gmdate( 'Y-m-d H:i:s' ) . '\' GMT (Greenwich Mean Time) time zone. '
