...
class Kunena implements iKunena {
	...
	public static function buildVersion() {
		if (self::$version === false) {
			...
			self::$version = ('1.6.4' == '@' . 'kunenaversion' . '@') ? strtoupper ( $version [1] . '-SVN' ) : strtoupper ( '1.6.4' );
			self::$version_date = ('2011-05-07' == '@' . 'kunenaversiondate' . '@') ? $svn [2] : '2011-05-07';
			self::$version_name = ('Kerkrade' == '@' . 'kunenaversionname' . '@') ? 'SVN Revision' : 'Kerkrade';
			self::$version_build = ('4832' == '@' . 'kunenaversionbuild' . '@') ? $svn [1] : '4832';
		}
		return self::$version;
	}
